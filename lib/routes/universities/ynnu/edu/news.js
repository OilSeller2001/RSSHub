...
module.exports = async (ctx) => {
    ...
    const denylist = new Set(['ynnu-mv.html', 'https://chjiao.ynnu.edu.cn/zsgz/zsjz.htm', 'https://chjiao.ynnu.edu.cn/info/1006/1404.htm', 'https://chjiao.ynnu.edu.cn/zsgz/dksw.htm']);
        ...
        item: await Promise.all([
            ...
            Promise.all(
                $index('div[carousel-item] > div')
                    .filter((_, element) => !denylist.has($index(element).find('a').attr('href')))
                    .map((_, element) => {
